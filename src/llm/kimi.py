"""Kimi (Moonshot AI) provider - https://api.moonshot.cn/v1"""
...
class KimiProvider(LLMProvider):
    """Kimi (Moonshot AI) provider using langchain_openai ChatOpenAI.

    Attributes:
        model: The Kimi model to use (default: kimi-k2).
    ...
    def health_check(self) -> bool:
        """Check if the Kimi provider is healthy.
